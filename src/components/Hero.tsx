...
export default function Hero() {
  ...
  const topBankIsReliable =
    !!topBank && topBank.reviewCount >= MIN_RELIABLE_REVIEW_COUNT;
          ...
          {reviewsLoading ? (
            ...
            <div className="report-card report-card-pro">
              <div className="rc-topline">
                {topBankIsReliable ? "Haftanın öne çıkan bankası" : "Yeni oluşan banka karnesi"}
              </div>
                ...
                <div className="bank-cell">
                  ...
                  <div>
                    ...
                    <div className="rc-sub">
                      {topBankIsReliable ? "LİDER BANKA" : "VERİ OLUŞUYOR"} · {topBank.reviewCount.toLocaleString("tr-TR")} YORUM
                    </div>
                  </div>
                </div>
