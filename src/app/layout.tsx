...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: "/icon-v28-192.png", sizes: "192x192", type: "image/png" },
      { url: "/icon-v28-512.png", sizes: "512x512", type: "image/png" },
    ],
    shortcut: ["/parakarne-favicon.ico"],
    apple: [{ url: "/apple-touch-icon-v28.png", sizes: "180x180", type: "image/png" }],
  },
  appleWebApp: {
    capable: true,
    title: "ParaKarne",
